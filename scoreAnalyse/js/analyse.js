$(function(){
	...
	//左右固定
	function fixed(){
		var mainL=$(".trend-main .single-r").offset().left;
		var mainW=$(".trend-main .single-r").outerWidth();
		$(".trend-main .single-l").css("left",mainL-225+"px");
		$(".trend-main .subject-select").css("left",mainL+mainW+20+"px");
	}
	fixed();
	...
	//选择学生
	$("body").on("click",".class-list dl dd",function(){
		$(this).addClass("dd-active").siblings().removeClass("dd-active");
		$(this).parent("dl").siblings().find("dd").removeClass("dd-active");
	})
